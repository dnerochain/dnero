...
const (
	...
	MessageType_MessageType_DneroGetAddress       MessageType = 56
	MessageType_MessageType_DneroAddress          MessageType = 57
	MessageType_MessageType_DneroSignTx           MessageType = 58
	MessageType_MessageType_DneroTxRequest        MessageType = 59
	MessageType_MessageType_DneroTxAck            MessageType = 60
	...
	MessageType_MessageType_DneroSignMessage      MessageType = 64
	MessageType_MessageType_DneroVerifyMessage    MessageType = 65
	MessageType_MessageType_DneroMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_DneroGetAddress",
	57:  "MessageType_DneroAddress",
	58:  "MessageType_DneroSignTx",
	59:  "MessageType_DneroTxRequest",
	60:  "MessageType_DneroTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_DneroSignMessage",
	65:  "MessageType_DneroVerifyMessage",
	66:  "MessageType_DneroMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_DneroGetAddress":       56,
	"MessageType_DneroAddress":          57,
	"MessageType_DneroSignTx":           58,
	"MessageType_DneroTxRequest":        59,
	"MessageType_DneroTxAck":            60,
	"MessageType_GetECDHSessionKey":     61,
	"MessageType_ECDHSessionKey":        62,
	"MessageType_SetU2FCounter":         63,
	"MessageType_DneroSignMessage":      64,
	"MessageType_DneroVerifyMessage":    65,
	"MessageType_DneroMessageSignature": 66,
...
func (m *DneroGetAddress) Reset()         { *m = DneroGetAddress{} }
func (m *DneroGetAddress) String() string { return proto.CompactTextString(m) }
func (*DneroGetAddress) ProtoMessage()    {}
func (*DneroGetAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{22}
}

func (m *DneroGetAddress) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroGetAddress.Unmarshal(m, b)
}
func (m *DneroGetAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroGetAddress.Marshal(b, m, deterministic)
}
func (m *DneroGetAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroGetAddress.Merge(m, src)
}
func (m *DneroGetAddress) XXX_Size() int {
	return xxx_messageInfo_DneroGetAddress.Size(m)
}
func (m *DneroGetAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroGetAddress.DiscardUnknown(m)
}

var xxx_messageInfo_DneroGetAddress proto.InternalMessageInfo

func (m *DneroGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DneroGetAddress) GetShowDisplay() bool {
	if m != nil {
		return m.ShowDisplay
	}
	return false
...
func (m *DneroAddress) Reset()         { *m = DneroAddress{} }
func (m *DneroAddress) String() string { return proto.CompactTextString(m) }
func (*DneroAddress) ProtoMessage()    {}
func (*DneroAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{24}
}

func (m *DneroAddress) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroAddress.Unmarshal(m, b)
}
func (m *DneroAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroAddress.Marshal(b, m, deterministic)
}
func (m *DneroAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroAddress.Merge(m, src)
}
func (m *DneroAddress) XXX_Size() int {
	return xxx_messageInfo_DneroAddress.Size(m)
}
func (m *DneroAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroAddress.DiscardUnknown(m)
}

var xxx_messageInfo_DneroAddress proto.InternalMessageInfo

func (m *DneroAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DneroSignTx) Reset()         { *m = DneroSignTx{} }
func (m *DneroSignTx) String() string { return proto.CompactTextString(m) }
func (*DneroSignTx) ProtoMessage()    {}
func (*DneroSignTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{49}
}

func (m *DneroSignTx) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroSignTx.Unmarshal(m, b)
}
func (m *DneroSignTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroSignTx.Marshal(b, m, deterministic)
}
func (m *DneroSignTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroSignTx.Merge(m, src)
}
func (m *DneroSignTx) XXX_Size() int {
	return xxx_messageInfo_DneroSignTx.Size(m)
}
func (m *DneroSignTx) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroSignTx.DiscardUnknown(m)
}

var xxx_messageInfo_DneroSignTx proto.InternalMessageInfo

func (m *DneroSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DneroSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *DneroSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *DneroSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *DneroSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *DneroSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *DneroSignTx) GetDataLength() uint32 {
	if m != nil {
		return m.DataLength
	}
	return 0
...
// func (m *DneroSignTx) GetChainId() uint32 {
// 	if m != nil {
// 		return m.ChainId
// 	}
// 	return 0
...
func (m *DneroTxRequest) Reset()         { *m = DneroTxRequest{} }
func (m *DneroTxRequest) String() string { return proto.CompactTextString(m) }
func (*DneroTxRequest) ProtoMessage()    {}
func (*DneroTxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{50}
}

func (m *DneroTxRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroTxRequest.Unmarshal(m, b)
}
func (m *DneroTxRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroTxRequest.Marshal(b, m, deterministic)
}
func (m *DneroTxRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroTxRequest.Merge(m, src)
}
func (m *DneroTxRequest) XXX_Size() int {
	return xxx_messageInfo_DneroTxRequest.Size(m)
}
func (m *DneroTxRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroTxRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DneroTxRequest proto.InternalMessageInfo

func (m *DneroTxRequest) GetDataLength() uint32 {
	if m != nil {
		return m.DataLength
	}
	return 0
...
func (m *DneroTxRequest) GetSignatureV() uint32 {
	if m != nil {
		return m.SignatureV
	}
	return 0
...
func (m *DneroTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *DneroTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
func (m *DneroTxAck) Reset()         { *m = DneroTxAck{} }
func (m *DneroTxAck) String() string { return proto.CompactTextString(m) }
func (*DneroTxAck) ProtoMessage()    {}
func (*DneroTxAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{51}
}

func (m *DneroTxAck) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroTxAck.Unmarshal(m, b)
}
func (m *DneroTxAck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroTxAck.Marshal(b, m, deterministic)
}
func (m *DneroTxAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroTxAck.Merge(m, src)
}
func (m *DneroTxAck) XXX_Size() int {
	return xxx_messageInfo_DneroTxAck.Size(m)
}
func (m *DneroTxAck) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroTxAck.DiscardUnknown(m)
}

var xxx_messageInfo_DneroTxAck proto.InternalMessageInfo

func (m *DneroTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
func (m *DneroSignMessage) Reset()         { *m = DneroSignMessage{} }
func (m *DneroSignMessage) String() string { return proto.CompactTextString(m) }
func (*DneroSignMessage) ProtoMessage()    {}
func (*DneroSignMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{52}
}

func (m *DneroSignMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroSignMessage.Unmarshal(m, b)
}
func (m *DneroSignMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroSignMessage.Marshal(b, m, deterministic)
}
func (m *DneroSignMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroSignMessage.Merge(m, src)
}
func (m *DneroSignMessage) XXX_Size() int {
	return xxx_messageInfo_DneroSignMessage.Size(m)
}
func (m *DneroSignMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroSignMessage.DiscardUnknown(m)
}

var xxx_messageInfo_DneroSignMessage proto.InternalMessageInfo

func (m *DneroSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DneroSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type DneroVerifyMessage struct {
...
func (m *DneroVerifyMessage) Reset()         { *m = DneroVerifyMessage{} }
func (m *DneroVerifyMessage) String() string { return proto.CompactTextString(m) }
func (*DneroVerifyMessage) ProtoMessage()    {}
func (*DneroVerifyMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{53}
}

func (m *DneroVerifyMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroVerifyMessage.Unmarshal(m, b)
}
func (m *DneroVerifyMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroVerifyMessage.Marshal(b, m, deterministic)
}
func (m *DneroVerifyMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroVerifyMessage.Merge(m, src)
}
func (m *DneroVerifyMessage) XXX_Size() int {
	return xxx_messageInfo_DneroVerifyMessage.Size(m)
}
func (m *DneroVerifyMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroVerifyMessage.DiscardUnknown(m)
}

var xxx_messageInfo_DneroVerifyMessage proto.InternalMessageInfo

func (m *DneroVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DneroVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *DneroVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
type DneroMessageSignature struct {
...
func (m *DneroMessageSignature) Reset()         { *m = DneroMessageSignature{} }
func (m *DneroMessageSignature) String() string { return proto.CompactTextString(m) }
func (*DneroMessageSignature) ProtoMessage()    {}
func (*DneroMessageSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{54}
}

func (m *DneroMessageSignature) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DneroMessageSignature.Unmarshal(m, b)
}
func (m *DneroMessageSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DneroMessageSignature.Marshal(b, m, deterministic)
}
func (m *DneroMessageSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DneroMessageSignature.Merge(m, src)
}
func (m *DneroMessageSignature) XXX_Size() int {
	return xxx_messageInfo_DneroMessageSignature.Size(m)
}
func (m *DneroMessageSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_DneroMessageSignature.DiscardUnknown(m)
}

var xxx_messageInfo_DneroMessageSignature proto.InternalMessageInfo

func (m *DneroMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DneroMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DneroGetAddress)(nil), "trezor.DneroGetAddress")
	proto.RegisterType((*Address)(nil), "trezor.Address")
	proto.RegisterType((*DneroAddress)(nil), "trezor.DneroAddress")
	...
	proto.RegisterType((*DneroSignTx)(nil), "trezor.DneroSignTx")
	proto.RegisterType((*DneroTxRequest)(nil), "trezor.DneroTxRequest")
	proto.RegisterType((*DneroTxAck)(nil), "trezor.DneroTxAck")
	proto.RegisterType((*DneroSignMessage)(nil), "trezor.DneroSignMessage")
	proto.RegisterType((*DneroVerifyMessage)(nil), "trezor.DneroVerifyMessage")
	proto.RegisterType((*DneroMessageSignature)(nil), "trezor.DneroMessageSignature")

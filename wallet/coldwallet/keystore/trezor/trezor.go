...
func GetEmptyObj(msgType MessageType) interface{} {
	...
	case 55:
		...
		return &v
	case 56:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroGetAddress)
		return &v
	case 57:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroAddress)
		return &v
	case 58:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroSignTx)
		return &v
	case 59:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroTxRequest)
		return &v
	case 60:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroTxAck)
		return &v
	case 61:
	...
	case 63:
		...
		return &v
	case 64:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroSignMessage)
		return &v
	case 65:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroVerifyMessage)
		return &v
	case 66:
		v := reflect.Indirect(reflect.New(t)).Interface().(DneroMessageSignature)
		return &v
	case 100:

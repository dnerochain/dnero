...
func TestPeerHandshakeAndCommunication(t *testing.T) {
	...
	messagesAtoB := []string{
		...
		"How's everything?",
		"The Dnero blockchain is awesome!",
		"The Dnero blockchain is the only end-to-end infrastructure for decentralized video streaming and delivery that provides both technical and economic solutions...This is one of the most exciting new blockchain ventures I have heard about.",
	}

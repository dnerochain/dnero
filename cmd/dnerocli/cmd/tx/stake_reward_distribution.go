...
// Example:
//		dnerocli tx distribute_staking_reward --chain="privatenet" --holder=0x36A8d78C0EaD519Bd155962358A3d57A404bC20d --beneficiary=0x88884a84d980bbfb7588888126fb903486bb8888 --split_basis_point=100 --seq=8
var stakeRewardDistributionCmd = &cobra.Command{
	Use:     "distribute_staking_reward",
	Short:   "Configure the distribution of the sentry/elite edge node staking reward",
	Example: `dnerocli tx distribute_staking_reward --chain="privatenet" --holder=0x36A8d78C0EaD519Bd155962358A3d57A404bC20d --beneficiary=0x88884a84d980bbfb7588888126fb903486bb8888 --split_basis_point=100 --seq=8`,
...
func init() {
	...
	stakeRewardDistributionCmd.Flags().StringVar(&feeFlag, "fee", fmt.Sprintf("%dwei", types.MinimumTransactionFeeDTokenWei), "Fee")

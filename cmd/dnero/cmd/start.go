...
import (
	...
	"github.com/dnerochain/dnero/node"
	msg "github.com/dnerochain/dnero/p2p/messenger"
	msgl "github.com/dnerochain/dnero/p2pl/messenger"
...
func loadOrCreateKey() (*crypto.PrivateKey, error) {
	...
	if numAddrs == 0 {
		if len(nodePassword) != 0 {
			...
			fmt.Println("")
			fmt.Println("You are launching the Dnero Node for the first time. Welcome and please follow the instructions to setup the node.")
			fmt.Println("")

			firstPrompt := fmt.Sprintf("Please choose your password for the Dnero Node: ")
			...
			fmt.Println("")
			fmt.Println("-----------------------------------------------------------------------------------------------------")
			fmt.Println("IMPORTANT: Please store your password securely. You will need it each time you launch the Dnero node.")
			fmt.Println("-----------------------------------------------------------------------------------------------------")
			fmt.Println("")
		...
		prompt := fmt.Sprintf("Please enter the password to launch the Dnero node: ")
		if len(nodePassword) != 0 {
			password = nodePassword
		} else {
...
func printCountdown() {
	for i := 10; i >= 0; i-- {
		fmt.Printf("\rLaunching Dnero Blockchain: %d...", i)
...
func printWelcomeBanner() {
	...
	fmt.Println("#  / \\    / \\ ____ |  |   ____  ____   _____   ____                  #")                 
	fmt.Println("#  \\ \\/\\/  _/ __\\|  | _/ __\\/  _\\ /    \\_/ __ \\                #")                 
	fmt.Println("#   \\      /\\  ___/|  |_\\ \\__(  <_> |  Y Y \\ ___/                  #")                
	fmt.Println("#   \\__/\\  /\\___  |____/\\___ \\____/|__|_| /\\___  >                  #")              
	fmt.Println("#  ___ ___ /      \\/           \\/         \\/.__  \\/      .__              #")       
	fmt.Println("# \\_____ \\   ____   ___________  ____   ____ |  |__ _____  |__| ____        #")
	fmt.Println("#   |    | \\ /   \\_/ __\\_  __\\/  _\\_/ __\\|  |  \\__ \\ |  |/   \\       #")
	fmt.Println("#   |    `   |   | \\  ___/|  |\\(  <_>\\ \\___|   Y \\/ __\\|  |   | \\      #")
	fmt.Println("#   /_______ |___|  /\\___  |__| \\____/\\___  |___|  (____  |__|___|  /      #")
	fmt.Println("#          \\/   \\/     \\/                 \\/    \\/    \\/      \\/       #")
	fmt.Println("#                                                                             #")
	fmt.Println("#==================== T - E - S - T - C - H - A - I - N ======================#")//Temp
...
func printExitBanner() {
	...
	fmt.Println(" ########################################################### ")
	fmt.Println("#                                                           #")
	fmt.Println("#	  _________              _____.___.                      #")
	fmt.Println("#	 /   _____/ ____  ____  \\__  |   | ____  __ __          #")
	fmt.Println("#	\\_____ \\_/ __ _/ __ \\  /   |   |/  _\\|  | \\         #")
	fmt.Println("#	 /       \\  ___\\  ___/ \\____   (  <_> |  |  /         #")
	fmt.Println("#	/_______  /\\__  \\__  >  / ______|\\___/|____/          #")
	fmt.Println("#  ._._. ________\\/   \\/  \\/                 ._._.       #")
	fmt.Println("#  | | |\\______ \\  ____   ___________  ____   | | |       #")
	fmt.Println("#  | | |  |    |  \\/   \\_/ __\\_  __\\/  _ \\ | | |       #")
	fmt.Println("# \\|\\|  |    `   |   |  \\ ___/|  |\\(  <_> )\\|\\|       #")
	fmt.Println("#   ____ /_______  |___|  /\\__  |__|  \\____/   ____       #")
	fmt.Println("# \\/\\/        \\/    \\/    \\/              \\/\\/       #")
    fmt.Println("#                                                           #")
	fmt.Println(" ########################################################### ")
	fmt.Println("")

...
import (
	...
	p2pcmn "github.com/dnerochain/dnero/p2pl/common"

	"github.com/dnerochain/dnero/p2pl/peer"

	"github.com/dnerochain/dnero/p2pl"
	"github.com/dnerochain/dnero/p2pl/transport"
...
const (
	// dneroP2PProtocolPrefix            = "/dnero/1.0.0/"
...
func CreateMessenger(pubKey *crypto.PublicKey, seedPeerMultiAddresses []string,
	...
	if viper.GetString(common.CfgP2PProtocolPrefix) != "" {
		...
		protocolPrefix = "/dnero/" + viper.GetString(common.CfgGenesisChainID) + "/" + viper.GetString(common.CfgP2PVersion) + "/"
	}
...
func (msgr *Messenger) printStats() {
	...
	ret := "Received bytes:"
	for k := byte(0); k <= byte(common.ChannelIDSentry); k++ {
